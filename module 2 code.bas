...
Sub stock():
   ...
   ' loop through all lines of data
    For i = 2 To LastRow
        ...
        ' determine if we are within the same ticker info
        If (ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value) Then
            ...
            ' this code came from the first result on google on how to turn a cell into a percentage
            ...
            ' do the same for the percentage change
